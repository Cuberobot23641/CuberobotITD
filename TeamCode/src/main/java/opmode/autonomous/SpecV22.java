...
@Autonomous(name = "7+0 RED SPEC TURN")
public class SpecV22 extends OpMode {
    ...
    public void buildPaths() {
        ...
        scoreSpec3 = follower.pathBuilder()
                ...
                .addPath(
                        ...
                        new BezierLine(
                                new Point(9.000, 34.000, Point.CARTESIAN),
                                new Point(41.000, intakingPositions.get(2), Point.CARTESIAN)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndTimeoutConstraint(0)
        ...
        scoreSpec4 = follower.pathBuilder()
                .addPath(
                        ...
                        new BezierLine(
                                new Point(9.000, 34.000, Point.CARTESIAN),
                                new Point(41.000, intakingPositions.get(3), Point.CARTESIAN)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndTimeoutConstraint(0)
        ...
        scoreSpec5 = follower.pathBuilder()
                .addPath(
                        ...
                        new BezierLine(
                                new Point(9.000, 34.000, Point.CARTESIAN),
                                new Point(41.000, intakingPositions.get(4), Point.CARTESIAN)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndTimeoutConstraint(0)
        ...
        scoreSpec6 = follower.pathBuilder()
                .addPath(
                        ...
                        new BezierLine(
                                ...
                                new Point(41.000, 68.000, Point.CARTESIAN)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 19:
                if (!follower.isBusy()) {
                    follower.turnTo(Math.toRadians(15));
                    //robot.prepareGrabSpecimen.start();
                    setPathState(1234);
                }
                break;
